      ...
      <div className="mx-auto max-w-4xl">
        <header className="animate-fade-in">
          <div className="mt-8 max-w-3xl space-y-6 text-muted-foreground">
            ...
            <div className="space-y-1.5">
              <p className="text-base leading-8 sm:text-[17px]">
                我叫翟常昊，是一位大学生。日常主要使用 React、Next.js、Node.js
                和 Python 来进行开发，顺便鼓捣一些新奇的小玩意。
              </p>
              <p className="text-sm leading-6 text-muted-foreground/80 sm:text-[14px]">
                I&apos;m Changhao Zhai, a college student who mainly builds with
                React, Next.js, Node.js and Python, while also tinkering with
                new ideas for fun.
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-sm leading-6 text-muted-foreground/80 sm:text-[14px]">
                This site now serves as a home for my projects, blog posts and
                interests, where I keep documenting what I learn, build and
                think about.
              </p>
            </div>
          </div>
