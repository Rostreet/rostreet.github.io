		...
		<span className="wordmark-shell">
			...
			>
				<defs>
					...
					>
						<stop offset="0%" stopColor="var(--foreground)" stopOpacity="0.75" />
						<stop offset="48%" stopColor="var(--foreground)" stopOpacity="1" />
						<stop offset="100%" stopColor="var(--muted-foreground)" stopOpacity="0.72" />
						<animateTransform
					...
					<filter id="nav-wordmark-blur" x="-20%" y="-50%" width="140%" height="200%">
		...
		<nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/86 backdrop-blur-xl">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex h-16 items-center justify-between gap-4">
					<Link href="/" className="group inline-flex items-center" aria-label="返回首页">
						<NavigationWordmark />
					</Link>
